...
const CuisinesCarousel = () => {
    const renderItems = () => cuisines.map(item => <ReusableCarousel key={item.name} name={item.name} picture={item.picture} />)
...
const CategoriesCarousel = () => {
    const renderItems = () => categories.map(item => <ReusableCarousel key={item.name} name={item.name} picture={item.picture} />)
...
const ReusableCarousel = ({...item}: CategoriesCuisinesCarouselType) => {
