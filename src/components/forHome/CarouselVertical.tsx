...
export const CarouselVertical = ({...items}: ReuseableCarouselType) => {
  ...
  return (
    <div className='xxs:w-36 md:w-48 relative flex flex-col items-center text-muted-foreground'>
        ...
        <div 
            className='flex flex-col items-center flex-nowrap overflow-y-clip gap-y-4 xxs:h-80 lg:h-96 bg-primary-content
            ...
            '>{renderData()}</div>
        <Button className='bg-primary z-20' variant={'default'} onClick={() => handleCarousel("next")}>Next</Button>
    </div>
  )
}
