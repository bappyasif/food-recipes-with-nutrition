...
export const LocaleSwitcher = () => {
  ...
  return (
    <label htmlFor="locale-switcher" className='text-muted-foreground flex items-end gap-x-1.5'>
      ...
      <select
        ...
        className='flex items-end appearance-none bg-transparent font-semibold text-lg text-accent duration-1000 transition-all hover:text-card cursor-pointer rounded-sm leading-none p-0.5'
        defaultValue={locale}
        disabled={isPending}
