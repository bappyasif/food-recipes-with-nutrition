...
const MultipleSelectableFilters = () => {
    return (
        <Accordion
            type='multiple'
            className='grid xxs:grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 grid-flow-row gap-4 px-2 md:px-10'
        >
...
const RenderCheckboxTypes = ({ ...items }: ReuseableCheckboxTypes) => {
    ...
    return (
        <div className='my-2'>
            <div className='flex flex-wrap gap-4 max-h-20 overflow-y-scroll' style={{scrollbarWidth: "thin"}}>{rendertypes()}</div>
        </div>
    )
