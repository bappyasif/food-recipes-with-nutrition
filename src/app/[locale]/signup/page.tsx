...
export default function CredsUser() {
  ...
  return (
    <div className='flex gap-x-10 items-center justify-center min-h-full mb-40'>
      <div className='self-center my-10 min-h-full'>
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-special-foreground">Already signed-up?</h2>
        <Link className="flex w-full justify-center rounded-md bg-accent px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" href={"/api/auth/signin"}>Sign-In</Link>
      </div>
