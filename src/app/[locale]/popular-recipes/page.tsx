...
const PopularRecipesRoutePage = async () => {
  ...
  return (
    <div className='min-h-[100vh] flex flex-col gap-y-10 mx-1.5 lg:mx-10'>
      <div className='space-y-4'>
        <h1 className='font-bold text-content xxs:text-xl sm:text-2xl md:text-3xl xl:text-4xl mt-10'>Popular Recipes</h1>
        <h3 className='text-sm font-semibold text-content/80'>Real Recipe Image can be seen from Recipe Detail Page</h3>
      </div>

      <Suspense fallback={<h1 className='font-bold text-muted-foreground'>Loading....</h1>}>
